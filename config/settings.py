...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('DB_USER', 'eventos_user'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'eventos_password'),
...
# Session: renew expiry on each request so long-lived tabs stay authenticated.
